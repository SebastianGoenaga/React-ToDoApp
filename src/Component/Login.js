...
export class Login extends React.Component {
    ...
    handleSubmit(e) {
        ...
        if (localStorage.getItem('userName') === this.state.email && localStorage.getItem('password') === this.state.password) {
            localStorage.setItem('page', "Logged");
            this.props.reloadPage();
        }
        this.setState({ email: "", password: "", errorMessage: "Something went wrong", loading: false });
